package com.reussy.exodus.icecubemenus.utility;
...
public class ItemBuilder {
    ...
    private final Logger log = Logger.getLogger("IceCube");
     ...
     * @return The Builder
     */
    public ItemBuilder replaceString(String name, Object arg) {
     ...
     * @return The builder.
     */
    public ItemBuilder replaceString(Object... args) {
        for (int i = 1; i < args.length; i += 2) {
            replaceString(String.valueOf(args[i-1]), args[i]);
        }
        return this;
    }
     ...
     * @return The builder.
     */
    public ItemBuilder setDisplayNamePAPI(String name) {
        this.displayName = PlaceholderAPI.setPlaceholders(Bukkit.getPlayer("Reussy"), name);
        return this;
    }
     ...
     * @return The builder.
     */
    public ItemBuilder setLorePAPI(int index, String text) {
        if(this.lore == null) lore = new ArrayList<>();
     ...
     * @return The builder.
     */
    public ItemBuilder setLorePAPI(List<String> lore) {
        List<String> converted = null;

        for (String s : lore) {
            ChatColor.translateAlternateColorCodes('&', s);
            converted = PlaceholderAPI.setPlaceholders(Bukkit.getPlayer("Reussy"), lore);
        }
    ...
    public ItemBuilder addItemFlag(ItemFlag itemFlag){
        ...
        this.flags.add(new Flag(itemFlag));
        return this;
    }
    ...
    public ItemStack build() {
        ...
        if (flags != null){
            ...
            for (Flag flag : flags){
                meta.addItemFlags(flag.getItemFlag());
            }
        }
    ...
    public ItemBuilder buildFromConfiguration(ConfigurationSection section) {
        ...
        if(section.contains("data")) {
            String ac = section.getString("data");
    ...
    private static class Flag {
        ...
        private Flag(ItemFlag itemFlag) {
